...
class blk(gr.sync_block):
    def __init__(self):
        ...
        self._m17_frame_size = 20  # M17 stream frame: sync (2) + payload (16) + counter (2)
    ...
    def work(self, input_items, output_items):
        ...
        if len(self._m17_buffer) >= self._m17_frame_size and len(self._key_buffer) >= 32:
            try:
                # Extract M17 frame
                ...
                if NACL_AVAILABLE and len(public_key) == 32 and len(signature) == 64:
                    ...
                    try:
                        ...
                        if is_valid:
                            ...
                            print(f"FAILED: M17 Codec2 frame signature is INVALID")
