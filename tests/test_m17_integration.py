...
try:
    from python.m17_frame import (
        M17Frame, M17EncryptionType, M17EncryptionSubtype,
...
try:
    ...
    try:
        ...
        from gr_linux_crypto.linux_crypto import decrypt
...
class TestM17FrameSynchronization:
    ...
    def test_frame_counter_sequence(self):
        ...
        assert len(set(nonces)) > 1, "Nonces should be different for different frame counters"
...
class TestM17Interoperability:
    ...
    def test_m17_demod_compatibility(self):
        ...
        try:
            ...
            assert result.returncode in [0, 1]  # 0 = success, 1 = may be normal for test
